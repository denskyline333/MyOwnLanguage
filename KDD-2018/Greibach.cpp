...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 6,
		Rule(NS('S'), GRB_ERROR_SERIES, 5,   // описывает общую структуру программы
			...
			Rule::Chain(4, TS('a'), TS('{'), NS('N'), TS('}'))
		),
		Rule(NS('F'), GRB_ERROR_SERIES + 1, 4, //описывает формальные параметры ф-ии
			Rule::Chain(4, TS('q'), TS('i'), TS(','), NS('F')),
			Rule::Chain(2, TS('q'), TS('i')),
			Rule::Chain(4, TS('n'), TS('i'), TS(','), NS('F')),
			Rule::Chain(2, TS('n'), TS('i'))
		),
		Rule(NS('N'), GRB_ERROR_SERIES + 2, 12,  // описывает возможные конструкции в ф-иях
			Rule::Chain(5, TS('e'), TS('n'), TS('i'), TS(';'), NS('N')),
			Rule::Chain(5, TS('e'), TS('q'), TS('i'), TS(';'), NS('N')),
			Rule::Chain(5, TS('i'), TS('='), NS('E'), TS(';'), NS('N')),
			Rule::Chain(3, TS('s'), TS(';'), NS('N')),
			Rule::Chain(4, TS('w'), NS('E'), TS(';'), NS('N')),
			Rule::Chain(3, TS('r'), TS('i'), TS(';')),
			Rule::Chain(3, TS('r'), TS('l'), TS(';')),
			Rule::Chain(4, TS('e'), TS('n'), TS('i'), TS(';')),
			Rule::Chain(4, TS('e'), TS('q'), TS('i'), TS(';')),
			Rule::Chain(4, TS('i'), TS('='), NS('E'), TS(';')),
			Rule::Chain(2, TS('s'), TS(';')),
			Rule::Chain(3, TS('w'), NS('E'), TS(';'))
		),
		Rule(NS('E'), GRB_ERROR_SERIES + 3, 16, //описывает выражения
			Rule::Chain(1, TS('i')),
			...
			Rule::Chain(5, TS('y'), TS('('), NS('W'), TS(')'), NS('M')),
			Rule::Chain(4, TS('b'), TS('('), NS('W'), TS(')')),
			Rule::Chain(5, TS('b'), TS('('), NS('W'), TS(')'), NS('M')),
			Rule::Chain(4, TS('u'), TS('('), NS('W'), TS(')')),
			Rule::Chain(5, TS('u'), TS('('), NS('W'), TS(')'), NS('M'))
		),
		Rule(NS('M'), GRB_ERROR_SERIES + 5, 4, // описывает арифметич знаки
			Rule::Chain(2, TS('+'), NS('E')),
			Rule::Chain(2, TS('-'), NS('E')),
			Rule::Chain(2, TS('*'), NS('E')),
			Rule::Chain(2, TS('/'), NS('E'))
		),
		Rule(NS('W'), GRB_ERROR_SERIES + 4, 4, //описывает фактически принимаемые параметры ф-ии
			Rule::Chain(1, TS('i')),
			Rule::Chain(1, TS('l')),
