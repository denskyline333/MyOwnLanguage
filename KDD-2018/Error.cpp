...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(107, "Попытка переопределения"),//lexanalize
		...
		ERROR_ENTRY(408, "Попытка деления на ноль"),
